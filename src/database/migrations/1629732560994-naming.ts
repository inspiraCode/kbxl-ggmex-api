...
export class naming1629732560994 implements MigrationInterface {
    name = 'naming1629732560994'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "units_available" ("id" SERIAL NOT NULL, "reason" character varying(100), "reason_comments" character varying(355), "commitment_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "availableId" integer, CONSTRAINT "PK_8e50d628f57bf93bb6f1d49c4df" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "availables" ("id" SERIAL NOT NULL, "available_comments" character varying(510), "available_date_commit" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_d051ea2ea7e0d27032f064c2e98" PRIMARY KEY ("id"))`);
